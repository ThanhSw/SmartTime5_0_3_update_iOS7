...
@interface WeekView : UIView<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UIScrollViewDelegate> 
{
...
@property (nonatomic,copy) NSDate	*currentDisplayDate;
@property (nonatomic,copy) NSDate	*firstDateInWeek;
@property (nonatomic,copy) NSDate	*lastDateInWeek;
...
@property(nonatomic,copy) NSDate *tueday;
@property(nonatomic,copy) NSDate *wednesday;
@property(nonatomic,copy) NSDate *thusday;
@property(nonatomic,copy) NSDate *friday;
//@property(nonatomic,retain) NSMutableArray *displayList;

@property(nonatomic,retain) SmartViewController	*SmartViewController;
@property(nonatomic,retain) Task *tmpTask;
