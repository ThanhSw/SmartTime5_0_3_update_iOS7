...
+(UIColor *)black;					//	0-0-0	000000	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)0 blue:(CGFloat)0 alpha:1];
}

+(UIColor *)darkSlateGray;			//	49-79-79	2f4f4f	 
{
	return [UIColor colorWithRed:(CGFloat)49/255 green:(CGFloat)79/255 blue:(CGFloat)79/255 alpha:1];
}

+(UIColor *)dimGray;				//	105-105-105	696969	 
{
	return [UIColor colorWithRed:(CGFloat)105/255 green:(CGFloat)105/255 blue:(CGFloat)105/255 alpha:1];
}

+(UIColor *)slateGray;				//	112-138-144	708090	 
{
	return [UIColor colorWithRed:(CGFloat)112/255 green:(CGFloat)138/255 blue:(CGFloat)144/255 alpha:1];
}

+(UIColor *)lightSlateGray;			//	119-136-153	778899	 
{
	return [UIColor colorWithRed:(CGFloat)119/255 green:(CGFloat)136/255 blue:(CGFloat)153/255 alpha:1];
}

+(UIColor *)gray;					//	190-190-190	bebebe	 
{
	return [UIColor colorWithRed:(CGFloat)190/255 green:(CGFloat)190/255 blue:(CGFloat)190/255 alpha:1];
}

+(UIColor *)lightGray;				//	211-211-211	d3d3d3
{
...
+(UIColor *)midnightBlue;			//	25-25-112	191970	 
{
	return [UIColor colorWithRed:(CGFloat)25/255 green:(CGFloat)25/255 blue:(CGFloat)112/255 alpha:1];
}

+(UIColor *)navy;					//	0-0-128	000080	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)0 blue:(CGFloat)128/255 alpha:1];
}

+(UIColor *)cornLowerBlue;			//	100-149-237	6495ed	 
{
	return [UIColor colorWithRed:(CGFloat)100/255 green:(CGFloat)149/255 blue:(CGFloat)237/255 alpha:1];
}

+(UIColor *)darkSlateBlue;			//	72-61-139	483d8b	 
{
	return [UIColor colorWithRed:(CGFloat)72/255 green:(CGFloat)61/255 blue:(CGFloat)139/255 alpha:1];
}

+(UIColor *)slateBlue;				//	106-90-205	6a5acd	 
{
	return [UIColor colorWithRed:(CGFloat)106/255 green:(CGFloat)90/255 blue:(CGFloat)205/255 alpha:1];
}

+(UIColor *)mediumSlateBlue;		//	123-104-238	7b68ee	 
{
	return [UIColor colorWithRed:(CGFloat)123/255 green:(CGFloat)104/255 blue:(CGFloat)238/255 alpha:1];
}

+(UIColor *)lightSlateBlue;			//	132-112-255	8470ff	 
{
	return [UIColor colorWithRed:(CGFloat)132/255 green:(CGFloat)112/255 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)mediumBlue;				//	0-0-205	0000cd	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)0 blue:(CGFloat)205/255 alpha:1];
}

+(UIColor *)royalBlue;				//	65-105-225	4169e1	 
{
	return [UIColor colorWithRed:(CGFloat)65/255 green:(CGFloat)105/255 blue:(CGFloat)225/255 alpha:1];
}

+(UIColor *)blue;					//	0-0-255	0000ff	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)0 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)dodgerBlue;				//	30-144-255	1e90ff	 
{
	return [UIColor colorWithRed:(CGFloat)30/255 green:(CGFloat)144/255 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)deepSkyBlue;			//	0-191-255	00bfff	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)191/255 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)skyBlue;				//	135-206-250	87ceeb	 
{
	return [UIColor colorWithRed:(CGFloat)135/255 green:(CGFloat)206/255 blue:(CGFloat)250/255 alpha:1];
}

+(UIColor *)lightSkyBlue;			//	135-206-250	87cefa	 
{
	return [UIColor colorWithRed:(CGFloat)135/255 green:(CGFloat)206/255 blue:(CGFloat)250/255 alpha:1];
}

+(UIColor *)steelBlue;				//	70-130-180	4682b4	 
{
	return [UIColor colorWithRed:(CGFloat)70/255 green:(CGFloat)130/255 blue:(CGFloat)180/255 alpha:1];
}

+(UIColor *)darkSteelBlue;				//	20-80-130	 
{
	return [UIColor colorWithRed:(CGFloat)20/255 green:(CGFloat)80/255 blue:(CGFloat)130/255 alpha:1];
}

+(UIColor *)lightSteelBlue;			//	176-196-222	b0c4de	 
{
	return [UIColor colorWithRed:(CGFloat)176/255 green:(CGFloat)196/255 blue:(CGFloat)222/255 alpha:1];
}

+(UIColor *)lightBlue;				//	173-216-230	add8e6	 
{
	return [UIColor colorWithRed:(CGFloat)173/255 green:(CGFloat)216/255 blue:(CGFloat)230/255 alpha:1];
}

+(UIColor *)powderBlue;				//	176-224-230	b0e0e6	 
{
	return [UIColor colorWithRed:(CGFloat)176/255 green:(CGFloat)224/255 blue:(CGFloat)230/255 alpha:1];
}

+(UIColor *)paleTurquoise;			//	175-238-238	afeeee	 
{
	return [UIColor colorWithRed:(CGFloat)175/255 green:(CGFloat)238/255 blue:(CGFloat)238/255 alpha:1];
}

+(UIColor *)parkTurquoise;			//	0-206-209	00ced1	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)206/255 blue:(CGFloat)209/255 alpha:1];
}

+(UIColor *)mediumTurquoise;		//	72-209-204	48d1cc	 
{
	return [UIColor colorWithRed:(CGFloat)72/255 green:(CGFloat)209/255 blue:(CGFloat)204/255 alpha:1];
}

+(UIColor *)turquoise;				//	64-224-208	40e0d0	 
{
	return [UIColor colorWithRed:(CGFloat)64/255 green:(CGFloat)224/255 blue:(CGFloat)208/255 alpha:1];
}

+(UIColor *)cyan;					//	0-255-255	00ffff	 
{
	return [UIColor colorWithRed:(CGFloat)0 green:(CGFloat)255/255 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)lightCyan;				//	224-255-255	e0ffff	 
{
	return [UIColor colorWithRed:(CGFloat)224/255 green:(CGFloat)255/255 blue:(CGFloat)255/255 alpha:1];
}

+(UIColor *)cadetBlue;				//	95-158-160	5f9ea0	 
{
	return [UIColor colorWithRed:(CGFloat)95/255 green:(CGFloat)158/255 blue:(CGFloat)160/255 alpha:1];
}


#pragma mark greens

+(UIColor *)mediumAquamarine;		//	102-205-170	66cdaa	 
{
	return [UIColor colorWithRed:(CGFloat)102/255 green:(CGFloat)205/255 blue:(CGFloat)170/255 alpha:1];
}

+(UIColor *)aquamarine;				//	127-255-212	7fffd4	 
{
	return [UIColor colorWithRed:(CGFloat)127/255 green:(CGFloat)255/255 blue:(CGFloat)212/255 alpha:1];
}

+(UIColor *)darkGreen;				//	0-100-0	006400	 
{
	return [UIColor colorWithRed:0 green:(CGFloat)100/255 blue:0 alpha:1];
}

+(UIColor *)darkOliveGreen;			//	85-107-47	556b2f	 
{
	return [UIColor colorWithRed:(CGFloat)85/255 green:(CGFloat)107/255 blue:(CGFloat)47/255 alpha:1];
}

+(UIColor *)darkSeaGreen;			//	143-188-143	8fbc8f	 
{
	return [UIColor colorWithRed:(CGFloat)143/255 green:(CGFloat)188/255 blue:(CGFloat)143/255 alpha:1];
}

+(UIColor *)seaGreen;				//	46-139-87	2e8b57	 
{
	return [UIColor colorWithRed:(CGFloat)46/255 green:(CGFloat)139/255 blue:(CGFloat)87/255 alpha:1];
}

+(UIColor *)mediumSeaGreen;			//	60-179-113	3cb371	 
{
	return [UIColor colorWithRed:(CGFloat)60/255 green:(CGFloat)179/255 blue:(CGFloat)113/255 alpha:1];
}

+(UIColor *)lightSeaGreen;			//	32-178-170	20b2aa	 
{
	return [UIColor colorWithRed:(CGFloat)32/255 green:(CGFloat)178/255 blue:(CGFloat)170/255 alpha:1];
}

+(UIColor *)paleGreen;				//	152-251-152	98fb98	 
{
	return [UIColor colorWithRed:(CGFloat)152/255 green:(CGFloat)251/255 blue:(CGFloat)152/255 alpha:1];
}

+(UIColor *)springGreen;			//	0-255-127	00ff7f	 
{
	return [UIColor colorWithRed:0 green:(CGFloat)255/255 blue:(CGFloat)127/255 alpha:1];
}

+(UIColor *)lawnGreen;				//	124-252-0	7cfc00	 
{
	return [UIColor colorWithRed:(CGFloat)124/255 green:(CGFloat)252/255 blue:0 alpha:1];
}

+(UIColor *)chartreuse;				//	127-255-0	7fff00	 
{
	return [UIColor colorWithRed:(CGFloat)127/255 green:(CGFloat)255/255 blue:0 alpha:1];
}

+(UIColor *)mediumSpringGreen;		//	0-250-154	00fa9a	 
{
	return [UIColor colorWithRed:0 green:(CGFloat)250/255 blue:(CGFloat)154/255 alpha:1];
}

+(UIColor *)greenYellow;			//	173-255-47	adff2f	 
{
	return [UIColor colorWithRed:(CGFloat)95/255 green:(CGFloat)158/255 blue:(CGFloat)160/255 alpha:1];
}

+(UIColor *)limeGreen;				//	50-205-50	32cd32	 
{
	return [UIColor colorWithRed:(CGFloat)50/255 green:(CGFloat)205/255 blue:(CGFloat)50/255 alpha:1];
}

+(UIColor *)yellowGreen;			//	154-205-50	9acd32	 
{
	return [UIColor colorWithRed:(CGFloat)154/255 green:(CGFloat)205/255 blue:(CGFloat)50/255 alpha:1];
}

+(UIColor *)forestGreen;			//	34-139-34	228b22	 
{
	return [UIColor colorWithRed:(CGFloat)34/255 green:(CGFloat)139/255 blue:(CGFloat)34/255 alpha:1];
}

+(UIColor *)oliveDrab;				//	107-142-35	6b8e23	 
{
	return [UIColor colorWithRed:(CGFloat)107/255 green:(CGFloat)142/255 blue:(CGFloat)35/255 alpha:1];
}

+(UIColor *)darkKhaki;				//	189-183-107	bdb76b	 
{
	return [UIColor colorWithRed:(CGFloat)189/255 green:(CGFloat)183/255 blue:(CGFloat)107/255 alpha:1];
}

+(UIColor *)khaki;					//	240-230-140	f0e68c	 
{
...
#pragma mark yellows
+(UIColor *)paleGoldenrod;			//	238-232-170	eee8aa	 
{
	return [UIColor colorWithRed:(CGFloat)238/255 green:(CGFloat)232/255 blue:(CGFloat)170/255 alpha:1];
}

+(UIColor *)lightGoldenrodYellow;	//	250-250-210	fafad2	 
{
	return [UIColor colorWithRed:(CGFloat)250/255 green:(CGFloat)250/255 blue:(CGFloat)210/255 alpha:1];
}

+(UIColor *)lightYellow;			//	255-255-224	ffffe0	 
{
	return [UIColor colorWithRed:(CGFloat)255/255 green:(CGFloat)255/255 blue:(CGFloat)224/255 alpha:1];
}

+(UIColor *)yellow;					//	255-255-0	ffff00	 
{
	return [UIColor colorWithRed:(CGFloat)255/255 green:(CGFloat)255/255 blue:0 alpha:1];
}

+(UIColor *)gold;					//	255-215-0	ffd700	 
{
	return [UIColor colorWithRed:(CGFloat)255/255 green:(CGFloat)215/255 blue:0 alpha:1];
}

+(UIColor *)lightGoldenrod;			//	238-221-130	eedd82	 
{
	return [UIColor colorWithRed:(CGFloat)238/255 green:(CGFloat)221/255 blue:(CGFloat)130/255 alpha:1];
}

+(UIColor *)goldenrod;				//	218-165-32	daa520	 
{
	return [UIColor colorWithRed:(CGFloat)218/255 green:(CGFloat)165/255 blue:(CGFloat)32/255 alpha:1];
}

+(UIColor *)darkGoldenrod;			//	184-134-11	b8860b	 
{
